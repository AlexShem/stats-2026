...
#: Первый вторник серии. Занятия начались неделей позже календарного начала
#: семестра: первый семинар — 8 сентября, дальше строго по вторникам.
FIRST_SEMINAR = dt.date(2026, 9, 8)
